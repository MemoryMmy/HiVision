...
map.on('load',function() {
    ...
    map.addSource('test', {
        'type': 'raster',
        'tiles': ["http://www.higis.org.cn:10082/HiVision/acnt/0/0/0/Z-0/0.8/{z}/{x}/{y}.png"],
        'tileSize':256,
        'minzoom': 0,
        'maxzoom': 24
    });
    ...
    Enter.addEventListener('click', function () {
        ...
        var pattern_value = layerEl.value;
        ...
        map.addSource(id, {   
            'type': 'raster',
            'tiles': [`http://www.higis.org.cn:10082/HiVision/acnt/${layerColor._r}/${layerColor._g}/${layerColor._b}/${pattern_value}/${layerColor._a}/{z}/{x}/{y}.png`],
            'tileSize':256,
            'minzoom': 0,
            'maxzoom': 24
        });

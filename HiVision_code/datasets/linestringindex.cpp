...
*    description :
*    create indexes(Linestring objects)
*    dependency :
*    gdal2.10  boost1.64 
*    run :
* 	./Linestringindex --shp alaska_OSM/gis_osm_railways_free_1.shp --output ../indexes/lrailway --rediskey lrailway --redishost 127.0.0.1 --redisport 6379
*/
